...
import pay  # Assumes that pay.py handles the payment page

# Function to open preview window and display bid details
    ...
    if status.lower() == "won":
        ...
        def submit_review():
            ...
            try:
                ...
                # Attempt to insert the review, relying on the trigger to check for duplicates
